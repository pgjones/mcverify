...
r_max: 793.75, // Sphere Outer radius of the Vessel, mm
r_min: 728.98,  // Tower Outer radius of the Vessel, mm
size_z: 3210.5, // half height
position: [0.0, 0.0, 9345.0],	// where does the dark acrylic start?
...
//belly_ropes and belly_plates share the same DB file with locations
pos_table: "BR_BP_LOCATION",
...
{
name: "GEO",
index: "belly_ropes_av",
valid_begin: [0, 0],
valid_end: [0, 0],
enable: 1,

mother: "belly_groove_av",
daughter_array: 1,
